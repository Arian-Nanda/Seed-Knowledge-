#!/usr/bin/env python3
"""
wiki_fetch_villager.py

Phase 6 of pulling wiki content into our knowledge base - Villager
professions and trading this time.
"""
...
def main():
    ...
    content = get_page_wikitext("Trading")
    if not content:
        print("Not found.")
        return
    print(f"Found it - {len(content)} characters.")
    out_path = os.path.join(OUTPUT_DIR, "Trading.txt")
